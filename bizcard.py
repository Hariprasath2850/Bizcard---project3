...
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By HARIPRASATH ",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *HARIPRASATH *!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("bg.jpg"), width=500)
